 ...
 *
 */
public class TestThreadThread extends Thread { // create thread by extending a thread class
	...
	public void run() {
		...
		System.out.println(ldt + ": This is currently running on the separate thread, " + "the id is: "
